...
function ShopPage2({ productId, onBack }) {
    ...
    const deleteCurrentImage = async () => {
        if (currentImg === 0) return; // can't delete main image here
                    ...
                    <div className="sp2-modal sp2-order-modal">
                        { sent
                            ...
                            : <>
                                ...
                                <p className="sp2-modal-sub">{ product.name } — size { selectedSize } — ${ Number(product.price).toFixed(2) }</p>
